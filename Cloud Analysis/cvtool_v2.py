...
# Main class
class CVTool:
    def __init__(self, main_folder="images"):
    ...
    def init_bar(self):
        ...
        for class_name in self.classes:
            folder = "images/" + class_name
            folder_list = os.listdir(folder)
            self.bar[class_name] = len(folder_list)
        print(self.bar)

    # Computes the cloud coverage percentage in an image, using K-means algorithm
    ...
    # Scanning all the images of the main folder, to compute cloud coverage
...
def main():
    cvtool = CVTool() # create cvtool object
    # print results (wait few minutes ...)
